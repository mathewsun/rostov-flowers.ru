...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<div class="textBlock">
		<p>
			Оплачивая заказ обязательно созвонитесь с менеджером по телефону <strong>8-863-256-02-46</strong> и уточните конкретную сумму, 
		...
		<p>
			Эту возможность уточняйте у менеджера по телефону <strong>8-863-256-02-46</strong>.
		</p>
		<p>
			<br />
		</p>
